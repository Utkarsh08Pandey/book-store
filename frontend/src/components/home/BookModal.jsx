  ...
  return (
    <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center' onClick={onClose}>
        <div onClick={(e)=>e.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
            ...
            <p className="my-2">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem neque eveniet sint dolor commodi perspiciatis iusto hic quidem excepturi magnam?Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum beatae distinctio minima neque eaque! Iure ducimus maxime recusandae similique possimus.
            </p>
        </div>
    </div>
  )
